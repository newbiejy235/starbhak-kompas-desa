...
export default function AdminProfile() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold text-[#111111] mb-6">Profil Admin</h1>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 mb-6 grid sm:grid-cols-2 gap-4 text-sm">
        ...
        <p className="flex items-center gap-2 text-gray-600"><ShieldCheck size={16} className="text-[#025246]" /> Administrator</p>
        <p className="text-xs text-gray-400">Terdaftar sejak {formatDate(p.createdAt)}</p>
      </div>
