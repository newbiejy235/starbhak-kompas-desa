...
const HELP_CATEGORIES = [
  {
    ...
    description: "Cara memesan, mengubah, atau membatalkan pesanan.",
  },
  {
    id: "payment",
    icon: CreditCard,
    title: "Masalah Pembayaran",
    description: "Pesanan belum lunas, gagal bayar, atau pengembalian dana.",
  },
  {
    id: "delivery",
    icon: Truck,
    title: "Masalah Pengiriman",
    description: "Jadwal kirim dan kondisi produk saat tiba.",
  },
] as const;
  ...
  return (
    <div className="mx-auto max-w-4xl animate-fade-up">
      ...
      <section className="mb-6 flex flex-col gap-3 sm:flex-row">
        ...
        >
          <MessageSquareWarning size={18} className="shrink-0 text-warning" />
          <span>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="flex w-full items-center justify-between gap-3 px-4 py-3.5 text-left transition-colors duration-150 hover:bg-gray-50"
                  >
