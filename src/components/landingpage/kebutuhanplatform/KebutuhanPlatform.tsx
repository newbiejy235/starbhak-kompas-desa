...
import { Sparkles, ShoppingBag, Truck, Handshake, ArrowUpRight } from 'lucide-react'
...
export function FiturUtamaSec() {
  ...
  return (
    <section className="relative w-full py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[350px] bg-emerald-50/50 blur-[120px] rounded-full pointer-events-none -z-10" />
