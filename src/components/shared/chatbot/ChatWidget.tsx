...
const MessageBubble = memo(function MessageBubble({ msg }: { msg: ChatMessage }) {
  ...
  return (
    <div className={`flex ${isMe ? "justify-end" : "justify-start"}`}>
      <div
        className={`max-w-[85%] px-3.5 py-2.5 text-[13px] leading-relaxed break-words whitespace-pre-wrap shadow-sm ${
          isMe
        ...
        >
          ...
          <header className="flex items-center gap-3 px-4 py-3.5 bg-primary text-white shrink-0 shadow-sm z-10">
            ...
            <div className="min-w-0 flex-1 leading-tight">
              <p className="text-[14px] font-bold truncate">Asisten KompasDesa</p>
              <p className="text-[11px] text-white/80 font-medium">Selalu siap membantu</p>
            </div>
            <button
              type="button"
